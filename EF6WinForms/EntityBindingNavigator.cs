...
namespace EFWinforms {
    ...
    public partial class EntityBindingNavigator :
        ...
        public void UpdateContextButtons() {
            _btnSave.Enabled = _btnUndo.Enabled = _btnRefresh.Enabled = HasChanges;
        }

        public bool HasChanges => EntityDataSource != null
                && EntityDataSource.DbContext != null && EntityDataSource.DbContext.ChangeTracker.HasChanges();
